...
int ImportFrontendModelFileWithPartition(llvm::StringRef model_fname,
    std::vector<mlir::MLIRContext*> &contextList, std::vector<mlir::OwningOpRef<mlir::ModuleOp>> &partModules,
    std::string *errorMessage, ImportOptions options = ImportOptions());
