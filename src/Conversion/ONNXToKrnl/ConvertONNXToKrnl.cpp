...
public:
  ...
  static std::vector<std::pair<int64_t, std::string>> inOutDims_;
//  static std::vector<std::string> entryPointNames_;
...
//    std::cout << "== [concatTypeString] == " << std::endl;
...
//            std::cout << "rank = " << rank << std::endl;
            ...
            for (int j = 0; j < rank; j++) {
              ...
              inputAry = (inputAry + comma);
              inputAry = (inputAry + std::to_string(dimSize));
          ...
          if(rank > 0) {
//            std::cout << "randk, inputAry = " << rank << ", " << inputAry << std::endl;
            inOutDims_.push_back(std::make_pair(rank, inputAry));
          }
        })
...
//    entryPointNames_.clear();
    ...
    onnx_mlir::inOutDims_ = inOutDims_;

    return dString;
  }
};

std::vector<std::pair<int64_t, std::string>> ONNXEntryPointLowering::inOutDims_ = {};
//std::vector<std::string> ONNXEntryPointLowering::entryPointNames_ = {};
...
//  std::cout << "== [populateONNXToKrnlConversionPattern] == " << std::endl;
