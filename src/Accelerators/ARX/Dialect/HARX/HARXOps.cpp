...
void HARXDialect::initialize() {
  addAttributes<
#define GET_ATTRDEF_LIST
#include "src/Accelerators/ARX/Dialect/HARX/HARXAttributes.cpp.inc"
      >();
  addOperations<
#define GET_OP_LIST
#include "src/Accelerators/ARX/Dialect/HARX/HARXOps.cpp.inc"
      >();
}
...
#include "src/Accelerators/ARX/Dialect/HARX/HARXDialect.cpp.inc"
