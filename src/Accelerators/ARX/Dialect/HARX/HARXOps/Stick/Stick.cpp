...
#include "src/Accelerators/ARX/Dialect/HARX/HARXOps/Stick/ONNXHARXStick.inc"
...
void HARXStickOp::build(OpBuilder &builder, OperationState &state, Value input,
...
LogicalResult HARXStickOpShapeHelper::computeShape() {
  auto stickOp = llvm::dyn_cast<HARXStickOp>(op);
  HARXStickOp::Adaptor operandAdaptor(operands);
...
LogicalResult HARXStickOp::inferShapes(
  ...
  HARXStickOpShapeHelper shapeHelper(getOperation());
  Type elementType =
...
void HARXStickOp::getCanonicalizationPatterns(
