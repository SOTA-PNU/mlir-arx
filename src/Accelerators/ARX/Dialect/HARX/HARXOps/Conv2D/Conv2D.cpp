...
LogicalResult HARXConv2DOpShapeHelper::computeShape() {
  HARXConv2DOp convOp = llvm::dyn_cast<HARXConv2DOp>(op);
  HARXConv2DOp::Adaptor operandAdaptor(operands);
  // Get operands.
  // X: [B, HI, WI, CI]
...
LogicalResult HARXConv2DOp::verify() {
  HARXConv2DOpAdaptor operandAdaptor(*this);
  // Get operands.
...
LogicalResult HARXConv2DOp::inferShapes(
