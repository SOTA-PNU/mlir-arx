...
#include "src/Accelerators/ARX/Dialect/LARX/DialectBuilder.hpp"
...
ElementsAttr IndexExprBuilderForLARX::getConst(Value value) { return nullptr; }

Value IndexExprBuilderForLARX::getVal(Value intArrayVal, uint64_t i) {
...
Value IndexExprBuilderForLARX::getShapeVal(
