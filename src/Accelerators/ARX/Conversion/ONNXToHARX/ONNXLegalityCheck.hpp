...
// legal or not. If an op is legal, it will NOT be lowered to HARX for ZAIU
// execution.
//
//===----------------------------------------------------------------------===//
...
/// Check if the input ARX level is compatible with the current ARX
/// level.
