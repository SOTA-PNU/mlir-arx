...
// =============================================================================
//
// The ARX constant values.
//
//===----------------------------------------------------------------------===//

#ifndef ONNX_MLIR_ARX_LIMIT_H
#define ONNX_MLIR_ARX_LIMIT_H

#include <stdint.h>

// Get maximum number of element for a given ARX tensor. Dim is a tensor/memref
...
// The ARX maximum supported tensor size (in bytes)
// by using zdnn_get_ARX_max_tensor_size()
// This value depends on HW.
static constexpr int64_t ARX_MAXIMUM_TENSOR_SIZE = 4294967296;
...
// The ARX levels.
static constexpr const char *ARX_Z16 = "z16";
