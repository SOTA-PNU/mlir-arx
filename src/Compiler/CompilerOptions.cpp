...
std::string deviceConfigFile_, partitionPlanFile_;
std::string emitFolder_;
...
static llvm::cl::opt<std::string, true> loadDeviceConfigsFileOpt(
    "device-cfg",
    llvm::cl::desc("Load a device config used in this compiler"),
    llvm::cl::location(deviceConfigFile_), llvm::cl::init(""),
    llvm::cl::cat(OnnxMlirOptions));

static llvm::cl::opt<std::string, true> loadPartitionPlanFileOpt(
    "partition-plan",
    llvm::cl::desc("Load a partition plan used in this compiler"),
    llvm::cl::location(partitionPlanFile_), llvm::cl::init(""),
    llvm::cl::cat(OnnxMlirOptions));

static llvm::cl::opt<std::string, true> emitFolderOpt(
    "emit-folder",
    llvm::cl::desc("Output directory"),
    llvm::cl::location(emitFolder_), llvm::cl::init(""),
    llvm::cl::cat(OnnxMlirOptions));
