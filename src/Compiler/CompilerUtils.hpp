...
//load device configuration file for partitioning
...
int processInputFileWithPartition(llvm::StringRef inputFilename, std::vector<mlir::MLIRContext*> &contextList,
    std::vector<mlir::OwningOpRef<mlir::ModuleOp>> &partModules, std::string *errorMessage, std::unique_ptr<Partition> partition);
