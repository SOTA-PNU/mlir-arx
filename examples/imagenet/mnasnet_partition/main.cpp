...
extern "C" OMTensorList *run_p0_mnasneto3(OMTensorList *);
extern "C" OMTensorList *run_p1_mnasneto3(OMTensorList *);
...
//  // Compute outputs.
  OMTensorList *tensorListOut = run_p0_mnasneto3(tensorListIn);
////
////  // Extract the output. The model defines one output of type tensor<1x10xf32>.
  ...
  tensorListOut = run_p1_mnasneto3(tensorListIn);
