...
extern "C" OMTensorList *run_p0_resnet50o3(OMTensorList *);
extern "C" OMTensorList *run_p1_resnet50o3(OMTensorList *);
...
int main(int argc, char **argv) {
  ...
  //  // Compute outputs.
  OMTensorList *tensorListOut = run_p0_resnet50o3(tensorListIn);
  ////
  ...
  tensorListOut = run_p1_resnet50o3(tensorListIn);
