...
//extern "C" OMTensorList *run_p0_bertsquado3(OMTensorList *);
//extern "C" OMTensorList *run_p1_bertsquado3(OMTensorList *);
//
...
//  // Compute outputs.
//  OMTensorList *tensorListOut = run_p0_bertsquado3(tensorListIn);
